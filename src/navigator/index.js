        ...
        return (
            <NavigationContainer
                onStateChange={(state) => {
                    ...
                    main_props.dispatch(
                        setGlobalParams(Object.assign(main_props.globalParams, {
                    ...
                    <Stack.Screen name={MAIN}
                        ...
                        {() => (
                            <Stack.Navigator
                                ...
                                headerMode="screen"
                                screenOptions={(prop) => {
                                    const drawerLockMode = prop.route.name !== 'LOGIN'
                                        ? 'unlocked'
                                        : 'locked-closed'
                                    ...
                                    return {
                                        ...
                                        headerLeft: (props) =>
                                            <HeaderLeft {...prop} {...props} />,
                                        headerRight: (props) =>
                                            <HeaderRight {...prop} {...props} />,
                                        headerTitle: (props) =>
                                            <HeaderTitle {...prop} {...props} />,
                                    }
                                }}>
                                {/*<Stack.Screen*/}
                                {/*    name={'CAMERA'}*/}
