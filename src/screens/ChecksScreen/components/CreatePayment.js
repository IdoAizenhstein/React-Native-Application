...
export default class CreatePayment extends PureComponent {
        ...
        if (this.state.idxObj !== params.transes.length - 1) {
            ...
            if (params.companyAccountId && params.targetType && isValid) {
                ...
                valuesSave.transes[valuesSave.transes.length - 1] = {
                    ...
                    paymentDesc: (valuesSave.transes[valuesSave.transes.length -
                    2].paymentDesc) ? String(
                        valuesSave.transes[valuesSave.transes.length - 2].paymentDesc) : '',
            ...
            if (params.companyAccountId && params.targetType && isValid) {
                ...
                valuesSave.transes.push({
                    ...valuesSave.transes[valuesSave.transes.length - 1],
                    paymentDesc: (valuesSave.transes[valuesSave.transes.length -
                    1].paymentDesc) ? String(
                        valuesSave.transes[valuesSave.transes.length - 1].paymentDesc) : '',
    ...
    dueDate = () => {
        const selectAcc = this.props.accounts.find(
            (item) => item.companyAccountId === this.state.obj.companyAccountId)
        if (this.state.obj.companyAccountId && selectAcc &&
            selectAcc.nonUpdateDays === 0) {
    ...
    getRecommendation = (month) => {
        ...
        const selectAcc = this.props.accounts.find(
            (item) => item.companyAccountId === obj.companyAccountId)
        if (this.state.obj.companyAccountId && selectAcc &&
            selectAcc.nonUpdateDays === 0) {
            const params = {
    ...
    editInput = (param) => () => {
        if (param === 'accounts') {
            ...
            this.getRecommendation(
                AppTimezone.moment(this.state.obj.transes[this.state.idxObj].dueDate)
                    .valueOf())
    ...
    render() {
        ...
        const selectAcc = this.props.accounts.find(
            (item) => item.companyAccountId === obj.companyAccountId)
        const itemRec = (dataTypePayments === 44 &&
            this.state.obj.companyAccountId && selectAcc &&
            selectAcc.nonUpdateDays === 0 && reommendationsList.length > 0)
            ? reommendationsList.find((item) => AppTimezone.moment(item.transDate)
                .isSame(
                    AppTimezone.moment(this.state.obj.transes[this.state.idxObj].dueDate),
                    'day'))
            : null
                        ...
                        {addMutavModal && (
                            <AddMutav
                                ...
                                companyAccountId={obj.companyAccountId
                                    ...
                                    : accountsAll.find(a => a.companyAccountId ===
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <View style={cs(
                                        ...
                                        {this.state.typeEditModal === 'dueDate' ? (
                                            <View>
                                                <TouchableOpacity
                                                    onPress={() => {
                                                        let valuesSave = Object.assign({}, this.state.obj)
                                                        if (valuesSave.transes[this.state.idxObj].dueDateOld) {
                                                            valuesSave.transes[this.state.idxObj].dueDateOld = null;
                                                        }
                                                        this.setState({
                                                            obj: valuesSave,
                                                        }, () => {
                                        ...
                                        <View>
                                            <TouchableOpacity
                                                onPress={() => {
                                                    let valuesSave = Object.assign({}, this.state.obj)
                                                    if (valuesSave.transes[this.state.idxObj].dueDateOld) {
                                                        valuesSave.transes[this.state.idxObj].dueDate = valuesSave.transes[this.state.idxObj].dueDateOld;
                                                    }
                                                    valuesSave.transes[this.state.idxObj].dueDateOld = null;
                                                    this.setState({
                                                        obj: valuesSave,
                                        ...
                                        {this.state.typeEditModal === 'dueDate' && (<View style={{
                                            ...
                                            <Calendar
                                                ...
                                                onDayPress={(day) => {
                                                    ...
                                                    let valuesSave = Object.assign({}, this.state.obj)
                                                    if (!valuesSave.transes[this.state.idxObj].dueDateOld) {
                                                        valuesSave.transes[this.state.idxObj].dueDateOld = valuesSave.transes[this.state.idxObj].dueDate
                                                    }
                                ...
                                {(this.state.typeEditModal === 'dueDate' && dataTypePayments ===
                                    ...
                                    <View style={[
                                        ...
                                        <TouchableOpacity
                                            style={
                                                {
                                                    opacity: (this.state.obj.companyAccountId &&
                                                        selectAcc && selectAcc.nonUpdateDays === 0)
                                                        ? 1
                                                        : 0.5,
                                                }
                                            }
                                            activeOpacity={!(this.state.obj.companyAccountId &&
                                                selectAcc && selectAcc.nonUpdateDays === 0) ? 0.5 : 1}
                                    ...
                                    <View
                                        ...
                                        <View style={{
                                            ...
                                            <TextInput
                                                ...
                                                onBlur={(e) => IS_IOS ? this.existingCheck(
                                                    e.nativeEvent.text) : null}
                                                onEndEditing={(e) => !IS_IOS ? this.existingCheck(
                                                    e.nativeEvent.text) : null}
                                    ...
                                    {this.state.obj.transes[this.state.idxObj].asmachtaExist &&
                                        (<View
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={{
                                                    color: colors.red2,
                                                    fontSize: sp((getFormattedValueArray(
                                                            this.state.obj.transes[this.state.idxObj].asmachtaExist.total)[0].toString().length >
                                                        4) ? 11 : 13),
                                                    lineHeight: 20,
                                                    textAlign: 'right',
