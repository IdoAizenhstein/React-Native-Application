                    ...
                    {!IS_IOS && (
                        <Fragment>
                            <Text style={{
                                ...
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getFreeDiskStorage '} {':'} {this.formatBytes(getFreeDiskStorage)}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getFreeDiskStorageOld '} {':'} {this.formatBytes(getFreeDiskStorageOld)}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getMaxMemory '} {':'} {this.formatBytes(getMaxMemory)}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getTotalDiskCapacity '} {':'} {this.formatBytes(getTotalDiskCapacity)}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getTotalDiskCapacityOld '} {':'} {this.formatBytes(getTotalDiskCapacityOld)}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getTotalMemory '} {':'} {this.formatBytes(getTotalMemory)}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'spaceMaxMemory '} {':'} {this.formatBytes(getMaxMemory - getUsedMemory)}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getUsedMemory '} {':'} {this.formatBytes(getUsedMemory)}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getBrand '} {':'} {getBrand}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getBuildNumber '} {':'} {getBuildNumber}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getBundleId '} {':'} {getBundleId}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getDeviceId '} {':'} {getDeviceId}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getDeviceType '} {':'} {getDeviceType}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getModel '} {':'} {getModel}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getSystemName '} {':'} {getSystemName}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getSystemVersion '} {':'} {getSystemVersion}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getUniqueId '} {':'} {getUniqueId}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getAndroidId '} {':'} {getAndroidId}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getApiLevel '} {':'} {getApiLevel}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getCarrier '} {':'} {getCarrier}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getCodename '} {':'} {getCodename}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getDevice '} {':'} {getDevice}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getDisplay '} {':'} {getDisplay}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getDeviceName '} {':'} {getDeviceName}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getFirstInstallTime '} {':'} {moment(getFirstInstallTime).format('DD/MM/YYYY')}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getHardware '} {':'} {getHardware}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getHost '} {':'} {getHost}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getIpAddress '} {':'} {getIpAddress}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getLastUpdateTime '} {':'} {moment(getLastUpdateTime).format('DD/MM/YYYY')}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getMacAddress '} {':'} {getMacAddress}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getManufacturer '} {':'} {getManufacturer}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getPhoneNumber '} {':'} {getPhoneNumber}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getPowerState '} {':'} {getPowerState}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getProduct '} {':'} {getProduct}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getPreviewSdkInt '} {':'} {getPreviewSdkInt}</Text>
                            <Text style={{
                                textAlign: 'center',
                                color: colors.blue32,
                                fontSize: sp(18),
                                fontFamily: fonts.regular,
                            }}>{'getUserAgent '} {':'} {getUserAgent}</Text>
                        </Fragment>
                    )}
                </View>
            </ScrollView>
