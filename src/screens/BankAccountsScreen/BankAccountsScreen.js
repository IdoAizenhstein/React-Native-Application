...
import CreditLimitModal
  from '../SettingsScreen/tabs/CreditCards/components/CreditLimitModal/CreditLimitModal'
...
export default class BankAccountsScreen extends PureComponent {
  constructor (props) {
    super(props)
    this.headerHeight = HeaderHeightContext._currentValue
