...
export default class CreatePayment extends PureComponent {
  ...
  constructor (props) {
    ...
    if (targetType === 'CYCLIC_TRANS') {
      paymentList = JSON.parse(
        JSON.stringify(this.props.searchkey.filter((it) => it.showInDrop)))
        .map((it) => {
          return {
            text: it.name,
    ...
    if (props.dataTransaction.mutavArray &&
      Array.isArray(props.dataTransaction.mutavArray) &&
      props.dataTransaction.mutavArray.length) {
      const mutavArray = props.dataTransaction.mutavArray.filter(
        (item) => item.biziboxMutavId)
    ...
    this.state = {
      ...
      disabledVal: (targetType) ? this.getRulesEdit(targetType) : {
        ...
        paymentDesc: false,
        transDate: false,
        total: targetType === 'CYCLIC_TRANS' &&
          props.dataTransaction.autoUpdateTypeName === 'AVG_3_MONTHS',
        transFrequencyName: targetType === 'CYCLIC_TRANS' &&
          props.dataTransaction.autoUpdateTypeName === 'AVG_3_MONTHS',
      },
  ...
  getRulesEdit (data) {
    ...
    switch (data) {
      ...
      case 'CYCLIC_TRANS':
        ...
        disabledVal.transFrequencyName = (this.state && this.state.obj)
          ? this.state.obj.autoUpdateTypeName !== 'USER_DEFINED_TOTAL'
          : this.props.dataTransaction.autoUpdateTypeName !==
          'USER_DEFINED_TOTAL'
        disabledVal.total = (this.state && this.state.obj)
          ? this.state.obj.autoUpdateTypeName !== 'USER_DEFINED_TOTAL'
          : this.props.dataTransaction.autoUpdateTypeName !==
          'USER_DEFINED_TOTAL'
        break
    ...
    getMutavApi.post({ body: { uuid: this.props.currentCompanyId } })
      .then(data => {
        ...
        setTimeout(() => {
          ...
          if (mutavArray.length === 1 && mutavArray[0].biziboxMutavId !==
            null) {
            mutavText = this.state.biziboxMutavList.find(
              (it) => it.biziboxMutavId ===
                mutavArray[0].biziboxMutavId).accountMutavName
  ...
  update = () => {
    ...
    this.setState({
      transNameNoValid: this.state.obj.transName === null ||
        this.state.obj.transName === '',
      ...
      totalNoValid: this.state.obj.total === null || this.state.obj.total ===
        '',
      paymentDescValid: this.state.obj.paymentDesc === null ||
        this.state.obj.paymentDesc === '',
    })

    if (this.state.obj.transName !== null && this.state.obj.transName !== '' &&
      this.state.obj.companyAccountId !== null &&
      this.state.obj.companyAccountId !== '' &&
      ...
      if (mutavArray &&
        ...
        mutavArray.forEach((it) => {
          it.accountMutavName = this.state.biziboxMutavList.find(
            (item) => item.biziboxMutavId === it.biziboxMutavId)
            ? this.state.biziboxMutavList.find((item) => item.biziboxMutavId ===
              it.biziboxMutavId).accountMutavName
            : null
        })
      }
    ...
    if (param === 'account') {
      ...
      if (!this.state.disabledVal.paymentDesc) {
        ...
        const selected = paymentList.find(
          (item) => item.id === this.state.obj.paymentDesc)
        if (selected) {
        ...
        getMutavApi.post({ body: { uuid: this.props.currentCompanyId } })
          .then(data => {
            ...
            if (!this.state.obj.mutavArray[this.state.idxObj].biziboxMutavId) {
              biziboxMutavListFilter = biziboxMutavListFilter.filter(
                (item) => !this.state.obj.mutavArray.some(
                  (it) => it.biziboxMutavId === item.biziboxMutavId))
            }
            this.setState({
              currentMutav: '',
              biziboxMutavList: data,
  ...
  setMutav = (mutav) => () => {
    if (this.state.obj.mutavArray[this.state.idxObj].biziboxMutavId &&
      ...
      let currentObjState = Object.assign({}, this.state.obj)
      if (!this.state.obj.mutavArray[this.state.idxObj].biziboxMutavId ||
        mutav.transTypeId !== 'f8dd5d61-fb5d-44ba-b7e6-65f25e7b2c6d') {
        currentObjState.mutavArray[this.state.idxObj].transTypeId = (this.props.categories &&
  ...
  handleToggleCheckBox = () => {
    ...
    obj.autoUpdateTypeName = obj.autoUpdateTypeName
      ? 'USER_DEFINED_TOTAL'
      : 'AVG_3_MONTHS'
  ...
  isValidList () {
    ...
    if (this.state.idxObj !== (params.mutavArray.length - 1)) {
      params.mutavArray.forEach((itemInside, idx) => {
        if ((params.mutavArray.length > (idx + 1)) &&
          (itemInside.biziboxMutavId === null || itemInside.total === null ||
            itemInside.total === '')) {
          isValid = false
        }
      })
      ...
      params.mutavArray.forEach((itemInside) => {
        if (itemInside.biziboxMutavId === null || itemInside.total === null ||
          itemInside.total === '') {
          isValid = false
        }
      })
  ...
  editMutav = (index) => () => {
    ...
    let isValid = true
    if ((this.state.idxObj !== (params.mutavArray.length - 1)) &&
      (params.mutavArray[this.state.idxObj].biziboxMutavId === null ||
        params.mutavArray[this.state.idxObj].total === null ||
        params.mutavArray[this.state.idxObj].total === '')) {
      isValid = false
      this.setState({
        totalArrayNoValid: params.mutavArray[this.state.idxObj].total ===
          null || params.mutavArray[this.state.idxObj].total === '',
        biziboxMutavValid: params.mutavArray[this.state.idxObj].biziboxMutavId !==
          null,
      })
    }
    // params.mutavArray.forEach((itemInside, idx) => {
  ...
  removeMutav = (index) => () => {
    ...
    this.setState({
      idxObj: (((valuesSave.mutavArray.length - 1) < 0)
        ? 0
        : (valuesSave.mutavArray.length - 1)),
      obj: valuesSave,
    })
  }

  modalMutavClose = () => {
    const mutavArray = this.state.obj.mutavArray.filter(
      (item) => item.biziboxMutavId && item.total !== null && item.total !== '')
    let valuesSave = Object.assign({}, this.state.obj)
    let valuesSaveDis = Object.assign({}, this.state.disabledVal)
    ...
    if (mutavArray.length === 1 && mutavArray[0].biziboxMutavId !== null) {
      ...
      mutavText = this.state.biziboxMutavList.find((it) => it.biziboxMutavId ===
        mutavArray[0].biziboxMutavId).accountMutavName
      valuesSave.transTypeId = mutavArray[0].transTypeId
      valuesSave.transName = (!valuesSave.expence ? 'העברה מ' : 'העברה ל') +
        ' ' + this.state.biziboxMutavList.find((it) => it.biziboxMutavId ===
          mutavArray[0].biziboxMutavId).accountMutavName
    } else if (mutavArray.length > 1) {
      valuesSave.transName = (!valuesSave.expence ? 'העברה מ' : 'העברה ל') +
        ' ' + mutavArray.length + ' מוטבים'
      const allSums = mutavArray.reduce((memo, it) => {
        return memo + Number(it.total)
      }, 0)
      valuesSave.total = allSums
      const transTypeIdCategory = [
        ...new Set(mutavArray.map(x => x.transTypeId.transTypeId))]
  ...
  addMutavim = (check) => {
    ...
    if (check) {
      if (params.mutavArray[this.state.idxObj].biziboxMutavId === null ||
        params.mutavArray[this.state.idxObj].total === null ||
        params.mutavArray[this.state.idxObj].total === '') {
        return
      }
    ...
    const indexes = params.mutavArray
      .map((it, i) => it.biziboxMutavId ===
      params.mutavArray[this.state.idxObj].biziboxMutavId ? i : null)
      .filter(i => i !== null)
    if (indexes.length > 1) {
      const idx = indexes.findIndex((item) => item !== idxObjnow)
      params.mutavArray.splice(indexes[idx], 1)
      this.setState({
        totalArrayNoValid: params.mutavArray[idxObjnow - 1].total === null ||
          params.mutavArray[idxObjnow - 1].total === '',
        biziboxMutavValid: params.mutavArray[idxObjnow - 1].biziboxMutavId !==
          null,
        idxObj: idxObjnow - 1,
        obj: valuesSave,
      })
    ...
    if (indexes.length > 1) {
      if ((this.state.idxObj !== (params.mutavArray.length - 1)) &&
        (params.mutavArray[idxObjnow - 1].biziboxMutavId === null ||
          params.mutavArray[idxObjnow - 1].total === null ||
          params.mutavArray[idxObjnow - 1].total === '')) {
        isValid = false
      }
    } else {
    ...
    if (isValid) {
      if (!valuesSave.mutavArray[valuesSave.mutavArray.length - 1].total &&
        !valuesSave.mutavArray[valuesSave.mutavArray.length -
        1].biziboxMutavId) {
        this.setState({
          idxObj: valuesSave.mutavArray.length - 1,
          obj: valuesSave,
        })
      } else {
  ...
  render () {
    ...
    const numberStyle = cs(dataTransaction.expence,
    ...
    if (this.state.biziboxMutavList && this.state.biziboxMutavList.length > 0) {
      const filterPeulotCount = this.state.biziboxMutavList.filter((item) => {
        return this.state.obj.mutavArray.some(
          (key) => key.biziboxMutavId === item.biziboxMutavId) &&
          item.peulotCount
      }).map((it) => {
                ...
                <View style={{
                  ...
                  <KeyboardAwareScrollView enableOnAndroid>
                    ...
                    {this.state.typeEditModal === 'transDate' && (<Calendar
                      minDate={this.today}
                      current={AppTimezone.moment(this.state.obj.transDate)
                        .format('YYYY-MM-DD')}
                      markedDates={{
                        [AppTimezone.moment(this.state.obj.transDate)
                          .format('YYYY-MM-DD')]: {
                          startingDay: true,
                          selected: true,
                          color: colors.blue3,
          ...
          <Modal
                    ...
                    <View
                      ...
                      <ScrollView
                        ...
                        {this.state.obj.mutavArray.map((c, i) => {
                          if ((i + 1) !== this.state.obj.mutavArray.length &&
                            c.total && c.biziboxMutavId) {
                            return (
                              <View
                                key={i}
                                style={[
                                  ...
                                  <TouchableOpacity
                                    ...
                                    <Text
                                      ...
                                      {(c.biziboxMutavId)
                                        ...
                                        this.state.biziboxMutavList.length >
                                        0 && this.state.biziboxMutavList.find(
                                          (it) => it.biziboxMutavId ===
                                            c.biziboxMutavId)
                                          ? ((this.state.biziboxMutavList.find(
                                            (it) => it.biziboxMutavId ===
                                              c.biziboxMutavId).accountMutavName))
                                          : '')
                                        : ''}
                                    </Text>
                                  </TouchableOpacity>
                      ...
                      <View style={[
                        ...
                        <TouchableOpacity
                          ...
                          <Text style={[
                            {
                              textAlign: 'right',
                              color: (!this.state.obj.mutavArray[this.state.idxObj].biziboxMutavId)
                                ? '#d0cece'
                                : '#0f3860',
                              fontSize: sp(15),
                              lineHeight: 42,
                            ...
                            {(this.state.obj.mutavArray[this.state.idxObj].biziboxMutavId)
                              ...
                              this.state.biziboxMutavList.find(
                                ...
                                ? ((this.state.biziboxMutavList.find(
                                  (it) => it.biziboxMutavId ===
                                    this.state.obj.mutavArray[this.state.idxObj].biziboxMutavId).accountMutavName))
                                : '')
                              : 'לא חובה'
                            }
                          </Text>
                    ...
                    <View style={[
                      ...
                      <View style={{
                        ...
                        <TouchableOpacity
                          ...
                          onPress={this.handleOpenCategoriesModalInside(
                            this.state.obj.mutavArray[this.state.idxObj].transTypeId)}
                        >
                          <View style={{
                            marginRight: 'auto',
                          }}>
                    ...
                    <View
                      ...
                      <View style={[
                        ...
                        <TextInput
                          ...
                          onEndEditing={(e) => {
                            let valuesSave = Object.assign({}, this.state.obj)
                            valuesSave.mutavArray[this.state.idxObj].total = e.nativeEvent.text.toString()
                              .replace(/[^\d.]/g, '')
                            this.setState({
                              obj: valuesSave,
                            ...
                            if (this.state.obj.mutavArray.length ===
                              this.state.idxObj + 1) {
                              setTimeout(() => this.addMutavim(true), 50)
                            }
                          }}
                          onChangeText={(totals) => {
                            if (String(totals).split('.').length > 2) {
                              ...
                              let valuesSave = Object.assign({}, this.state.obj)
                              valuesSave.mutavArray[this.state.idxObj].total = totals.toString()
                                .replace(/[^\d.]/g, '')
                              this.setState({
                                obj: valuesSave,
                                totalArrayNoValid: valuesSave.mutavArray[this.state.idxObj].total ===
                          ...
                          value={this.state.obj.mutavArray[this.state.idxObj].total
                            ? inputWorkaround.getWorkaroundChar() + String(
                            this.state.obj.mutavArray[this.state.idxObj].total)
                            : null}
            ...
            <Modal
                  ...
                  <View style={{
                    ...
                    {(!inProgressMutavList && biziboxMutavListFilter &&
                      ...
                      <SectionList
                        ...
                        keyExtractor={(
                          item, i) => `${item.biziboxMutavId}_${i}`}
              ...
              {addMutavModal && (
                <AddMutav
                  isEdit={mutavRow}
                  paymentDesc={this.state.obj.paymentDesc
                    ? this.state.obj.paymentDesc
                    : 'BankTransfer'}
                  companyId={currentCompanyId}
                  companyAccountId={this.state.obj.companyAccountId
                    ? this.state.obj.companyAccountId
                    : this.props.accounts[0].companyAccountId}
            ...
            <View style={{
              ...
              <View style={{
                ...
                <View style={cs(
                  ...
                  <View>
                    <TouchableOpacity
                      onPress={this.closeModalCreateEditTransaction}>
                      <Text style={{
                        fontSize: sp(16),
                        color: '#ffffff',
                        fontFamily: fonts.semiBold,
                  ...
                  <View style={{ alignItems: 'center' }}>
                    <Text style={{
                      ...
                      {dataTransaction.type === 'update'
                        ? 'עריכת'
                        : 'הוספת'} {dataTransaction.expence
                      ? 'הוצאה'
                      : 'הכנסה'} {'קבועה'}
                    </Text>
                  </View>
              ...
              <View style={{
                ...
                <KeyboardAwareScrollView enableOnAndroid>
                  <View style={[
                    ...
                    cs(this.state.disabledVal.account, { opacity: 1 },
                      { opacity: 0.3 })]}>
                    <View style={{
                      flex: 1.76,
                      alignItems: 'flex-end',
                    ...
                    <View style={[
                      ...
                      <View
                        ...
                        <Text style={[
                          {
                            textAlign: 'right',
                            color: (this.state.obj.mutavArray.length === 1 &&
                              this.state.obj.mutavArray[0].biziboxMutavId ===
                              null) ? '#d0cece' : '#0f3860',
                            fontSize: sp(15),
                            lineHeight: 42,
                          }, commonStyles.regularFont]}>
                  ...
                  <View
                    style={[
                      ...
                      cs(this.state.disabledVal.transName, { opacity: 1 },
                        { opacity: 0.3 })]}>
                    <View style={{
                      flex: 1.76,
                      alignItems: 'flex-end',
                  ...
                  {!textCategory && (
                    <View
                      style={[
                        ...
                        cs(this.state.disabledVal.transTypeName, { opacity: 1 },
                          { opacity: 0.3 })]}>
                      <View style={{
                        flex: 1.76,
                        alignItems: 'flex-end',
                  ...
                  <View
                    style={[
                      ...
                      cs(this.state.disabledVal.paymentDesc, { opacity: 1 },
                        { opacity: 0.3 })]}>
                    <View style={{
                      flex: 1.76,
                      alignItems: 'flex-end',
                        ...
                        <Text style={[
                          ...
                          {(this.state.obj.paymentDesc)
                            ...
                            this.props.searchkey.find(
                              ...
                              ? this.props.searchkey.find(
                                (it) => it.paymentDescription ===
                                  this.state.obj.paymentDesc).name
                              : '')
                            : 'בחר'}
                        </Text>
                      </TouchableOpacity>
                  ...
                  <View
                    style={[
                      ...
                      cs(this.state.disabledVal.transFrequencyName,
                      ...
                      >
                        ...
                        <Text style={[
                          ...
                          {this.state.transFrequencyName.find(
                            (item) => item.id ===
                              this.state.obj.transFrequencyName).text}
                        </Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  <View
                    style={[
                      ...
                      cs(this.state.disabledVal.transDate, { opacity: 1 },
                        { opacity: 0.3 })]}>
                    <View style={{
                      flex: 1.76,
                      alignItems: 'flex-end',
                    ...
                    <View style={{
                      ...
                      <TouchableOpacity
                        ...
                        <Text style={[
                          ...
                          this.state.obj.transDate).format('DD/MM/YY')}</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  <View
                    style={[
                      ...
                      cs(this.state.disabledVal.total, { opacity: 1 },
                        { opacity: 0.3 })]}>
                    <View style={{
                      flex: 1.76,
                      alignItems: 'flex-end',
                    ...
                    <View style={[
                      ...
                      {this.state.editSum && (
                        <TextInput
                          ...
                          onEndEditing={(e) => {
                            let valuesSave = Object.assign({}, this.state.obj)
                            valuesSave.total = e.nativeEvent.text.toString()
                              .replace(/[^\d.]/g, '')
                            this.setState({
                              obj: valuesSave,
                              editSum: false,
                          ...
                          onChangeText={(totals) => {
                            if (String(totals).split('.').length > 2) {
                              ...
                              let valuesSave = Object.assign({}, this.state.obj)
                              valuesSave.total = totals.toString()
                                .replace(/[^\d.]/g, '')
                              this.setState({
                                obj: valuesSave,
                                totalNoValid: valuesSave.total === '',
                          ...
                          value={this.state.obj.total !== null
                            ? inputWorkaround.getWorkaroundChar() +
                            String(this.state.obj.total)
                            : ''}
                          underlineColorAndroid="transparent"
                        />
                      )}
                    ...
                    <View style={{
                      ...
                      <TouchableOpacity
                        ...
                        <Text style={[
                          ...
                          {this.state.endDate.find((item) => item.id ===
                            this.state.obj.endDate).text} {(this.state.obj.endDate ===
                          'on')
                          ? AppTimezone.moment(this.state.obj.expirationDate)
                            .format('DD/MM/YY')
                          : (this.state.obj.endDate === 'times')
                            ? this.state.obj.timesValue + ' פעמים'
                            : ''}
                        </Text>
                      </TouchableOpacity>
                    </View>
                  ...
                  <View style={{
                    ...
                    <CheckBox
                      ...
                      checkedIcon="check"
                      uncheckedIcon="check"
                      checked={this.state.obj.autoUpdateTypeName ===
                      'AVG_3_MONTHS'}
